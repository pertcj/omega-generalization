...
import dataclasses
import random
from typing import Any, List, Mapping, Callable, Optional
...
def range_evaluation(
  ...
  results = []
  lengths = range(2, eval_params.max_test_length + 1)
  if use_tqdm:
    lengths = tqdm.tqdm(lengths)
  for length in lengths:
    if length % 32 == 0: # avoid compiling too many jitted functions, clear occasionally.
      jax.clear_caches()
    sub_accuracies = []
